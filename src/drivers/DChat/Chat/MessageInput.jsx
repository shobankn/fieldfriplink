...
const MessageInput = ({ chatId, receiverId, onOptimisticSend, className }) => {
  ...
  return (
    <div className={`fixed bottom-0 right-0 left-0 md:left-80 lg:left-140 xl:left-140 2xl:left-170   backdrop-blur-md border-t border-gray-200 z-20 transition-all duration-200 ${imagePreview ? 'pb-0' : ''}`}>
      ...
      <div className="p-4">
        <div className="flex items-end gap-3">
          <div className="flex-1 bg-gray-50 rounded-full flex items-center px-5 py-3 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            />
            <span
              className="ml-3 p-1.5 text-gray-500 hover:text-blue-500 transition-colors duration-200 cursor-pointer rounded-full hover:bg-gray-100"
