...
const handlePaymentSubmit = async (e) => {
  ...
  const baseCardClasses = 'p-6 bg-white rounded-lg border shadow-sm';
  const activeClasses = 'border-red-500 shadow-lg';
  const hoverClasses = 'hover:border-red-500 hover:shadow-md';
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm transition-opacity flex items-center justify-center z-50 px-4 sm:px-6">
      <div className="bg-white rounded-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 relative">
        <button
          onClick={onClose}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div
            ...
            className={`${baseCardClasses} ${
              selectedPlan === 'basic' ? activeClasses : `border-gray-200 ${hoverClasses} group`
          ...
          >
            ...
            <div>
              ...
              <button
                ...
                className={`w-full inter-semibold py-2 px-4 rounded-lg transition-all duration-200 transform 
                  ${selectedPlan === 'basic'
              ...
              >
                {paymentLoading && selectedPlan === 'basic' ? 'Processing...' : selectedPlan === 'basic' ? 'Proceed to Payment' : 'Choose Plan'}
              </button>
            </div>
          </div>
          ...
          <div
            ...
            className={`${baseCardClasses} ${
              selectedPlan === 'yearly' ? activeClasses : `border-gray-200 ${hoverClasses} group`
            } flex flex-col justify-between h-full cursor-pointer`}
          >
            <div>
              <div className="flex flex-col sm:flex-row justify-between items-start mb-8">
              ...
              <button
                ...
                className={`w-full inter-semibold py-2 px-4 rounded-lg transition-all duration-200 transform 
                  ${selectedPlan === 'yearly'
                    ...
                    : 'bg-[#CCCCCC] text-black group-hover:bg-[#E83E3E] group-hover:text-white group-hover:scale-[1.02] active:scale-[0.98]'}`}
              >
                {paymentLoading && selectedPlan === 'yearly' ? 'Processing...' : selectedPlan === 'yearly' ? 'Proceed to Payment' : 'Choose Plan'}
              </button>
            </div>
          </div>
        </div>
