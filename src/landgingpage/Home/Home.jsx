...
const Home = () => {
      ...
      <section className="bg-[#d02323] text-white px-[80px] flex flex-col lg:flex-row items-center justify-between gap-10 h-[500px]">
        <div className="lg:w-1/2">
          ...
          <div className="flex gap-4 flex-wrap">
            <button
              className="bg-[#facc15] text-black text-[14px] rounded-[6px] interbold w-[206px] h-[40px]"
  ...
  <FiShield style={{ fontSize: '27px', color: '#E83E3E' }} />
  <div>
...
<div className="flex items-start gap-2 mb-[23px]">
  <LuUsers style={{ fontSize: '27px', color: '#FFD700' }} />
  <div>
...
<div className="flex items-start gap-2">
  <FaRegClock style={{ fontSize: '27px', color: '#4CAF50' }} />
  <div>
    ...
    <p className="interregular text-[14px] text-[#555555]">Reduce delays and ensure every student gets to participate in enrichment activities.</p>
        ...
        <div className="text-center mt-10">
          ...
          <button
            className="bg-red-500 w-[400px] h-[40px] interbold text-[14px] text-white px-6 py-2 me-2 rounded-[6px] mt-[32px] hover:bg-red-600"
          ...
          <br />
          <button
            className="bg-yellow-400 w-[400px] h-[40px] interbold text-[14px] text-black py-2 rounded-[6px] mt-4 hover:bg-yellow-500"
      ...
      <section className="py-16 px-4 lg:px-20 bg-gray-100">
        ...
        <div className="flex col items-center justify-center gap-5 ">
          <div className="bg-[#2A2A2A] p-[32px] shadow-md w-[550px] rounded-[8px] text-[white]">
            ...
            <div className="flex mt-[21px] gap-[10px]">
              <span className="inline-block bg-[#E83E3E] h-[48px] w-[48px] text-center leading-[48px] rounded-full">
                RJ
              </span>
              <p>
                Robert Johnson
          ...
          <div className="bg-[#2A2A2A] p-[32px] shadow-md w-[550px] rounded-[8px] text-[white]">
            ...
            <div className="flex mt-[21px] gap-[10px]">
              <span className="inline-block bg-[#FFD700] h-[48px] w-[48px] text-center leading-[48px] rounded-full">
                RJ
              </span>
              <p>
                Robert Johnson
